...
<div class="navbar">
 ...
 <div class="main">
 	...
 	<div class="register">
 		<form action="<%= request.getContextPath() %>/createcustomer" method="post">
 		<table>
 			<tr>
 				<td>
 				...
 				<td>
 					<input type="number" id="SSN ID" name="SSN ID" required>
 				</td>
 			</tr>
 			<tr>
 				<td>
 			...
 			<tr>
 				<td>
 					<label class="required">State:</label>State:
 				</td>
 				<td>
 				<select name="state" class="states" id="stateId" size="1" required>
 			...
 			<tr>
 				...
 				<td>
 				<select name="city" class="cities" id="cityId" size="1" required>
